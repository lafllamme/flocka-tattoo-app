    ...
    <section id="work" class="surface-section page-shell border-b border-line py-24 md:py-36">
      ...
      <div class="grid gap-24">
        <article v-for="(project, index) in work" :key="project.title" class="grid gap-7 md:grid-cols-2">
          ...
          <FlockaReveal class="self-end"><a href="https://www.instagram.com/flockatattoo/" target="_blank" rel="noreferrer" class="group block overflow-hidden bg-surface" :aria-label="`View ${project.title}`"><img :src="project.image" :alt="project.title" class="aspect-[1.18] w-full object-cover grayscale transition duration-700 group-hover:scale-105 group-hover:grayscale-0"></a></FlockaReveal>
        </article>
      </div>
    </section>
