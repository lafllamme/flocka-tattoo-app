    ...
    <div class="surface-hero-stack">
      ...
      <section id="about" class="surface-card surface-section page-shell -mt-2 border-0 border-t-2 border-t-bone px-5 py-16 md:px-[2vw] md:py-24">
        ...
        <div class="about-layout mt-16 grid gap-16 md:mt-24 md:grid-cols-2 md:gap-x-24 md:gap-y-24">
          ...
          <FlockaReveal direction="right" class="md:col-start-2 md:row-start-2"><FlockaColorRevealImage src="https://i.ibb.co/CsmC686z/testimonial.webp" alt="Tattoo-Arbeit aus dem Portfolio von Flocka" class="aspect-[1.25] w-full border border-bone object-cover" /></FlockaReveal>
        </div>
      </section>
    </div>
