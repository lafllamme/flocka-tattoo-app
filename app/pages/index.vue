...
const services = [
  ...
  { title: 'SCHWARZ-ROT & FARBE', body: 'Klare Kontraste, starke Formen und rote oder farbige Akzente, wenn sie dem Motiv etwas geben.' },
...
const process = [
  ...
  { number: '02', title: 'ENTWURF', body: 'Aus dem ersten Gedanken wird eine klare Richtung – mit Größe, Rhythmus und einer eigenen Haltung.' },
  { number: '03', title: 'TÄTOWIEREN', body: 'Schablone, Linie, Schatten und rote oder farbige Details kommen in einer konzentrierten Session zusammen.' },
